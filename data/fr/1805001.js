window.fichePreparee={
  "nom": "Déesse Elizabeth",
  "designation": "[Guerrière Sacrée]",
  "titre": "Déesse Elizabeth",
  "idJeu": "1805001",
  "attribut": {
    "nom": "@attribute.3",
  ...
  "rareteParDefaut": "UR",
  "presentation": "Les compétences de bonus de [Guerrière Sacrée] Déesse Elizabeth peuvent considérablement réduire les dégâts subis par les alliés, ce qui augmente la capacité de survie de l'équipe.",
  "commandement": null,
  "talent": null,
  "grace": null,
  "union": null,
          ...
          "rangs": [
            {
              ...
              "description": "Inflige des dégâts égaux à 200 % de l'attaque à @target.oneEnemy.",
              "idJeu": 187001,
            ...
            },
            {
              "rang": 2,
              "multiplicateur": 200.0,
              "description": "Annule les postures de @target.oneEnemy, inflige des dégâts égaux à 200 % de l'attaque, puis applique [00D5FF]Étourdissement[-] pendant 1 tour(s).\\n\\n[00D5FF]※Étourdissement : empêche toute action.[-]",
              "idJeu": 187002,
            ...
            },
            {
              ...
              "description": "Annule les postures de @target.oneEnemy, inflige des dégâts égaux à 250 % de l'attaque, puis applique [00D5FF]Étourdissement[-] pendant 2 tour(s).\\n\\n[00D5FF]※Étourdissement : empêche toute action.[-]",
              "idJeu": 187003,
          ...
          "rangs": [
            {
              ...
              "description": "Crée une barrière autour de @target.allAllies égale à 150 % de l'attaque pendant 1 tour(s). Si attaqué, n'encaisse que les dégâts des stats de base.\\n[00D5FF](Hors Rupture)[-]",
              "idJeu": 187011,
              "cadre": "assets/skill-frames/rank-1.png",
            ...
            },
            {
              "rang": 2,
              "multiplicateur": 200.0,
              "description": "Crée une barrière autour de @target.allAllies égale à 200 % de l'attaque pendant 1 tour(s). Si attaqué, n'encaisse que les dégâts des stats de base.\\n[00D5FF](Hors Rupture)[-]",
              "idJeu": 187012,
              "cadre": "assets/skill-frames/rank-2.png",
              "iconeType": "assets/skill-frames/buff_global.png"
            },
            {
              ...
              "description": "Crée une barrière autour de @target.allAllies égale à 300 % de l'attaque pendant 2 tour(s). Si attaqué, n'encaisse que les dégâts des stats de base.\\n[00D5FF](Hors Rupture)[-]",
              "idJeu": 187013,
              "cadre": "assets/skill-frames/rank-3.png",
              "iconeType": "assets/skill-frames/buff_global.png"
            }
        ...
        "niveaux": [
          {
            "niveau": 1,
            "multiplicateur": 30.0,
            "description": "Restaure les PV de @target.allAllies à hauteur de 30 % de leurs PV max. [00D5FF]Renvoie[-] 40 % des dégâts reçus durant 2 tour(s), puis soigne la moitié des dégâts renvoyés.\\n\\n[00D5FF]※Renvoi : renvoie une partie des dégâts reçus à l'attaquant.[-]",
            "cadre": "assets/skill-frames/ultimate-normal-1.png"
          },
          {
            "niveau": 2,
            "multiplicateur": 35.0,
            "description": "Restaure les PV de @target.allAllies à hauteur de 35 % de leurs PV max. [00D5FF]Renvoie[-] 50 % des dégâts reçus durant 2 tour(s), puis soigne la moitié des dégâts renvoyés.\\n\\n[00D5FF]※Renvoi : renvoie une partie des dégâts reçus à l'attaquant.[-]",
            "cadre": "assets/skill-frames/ultimate-normal-2.png"
          },
          {
            "niveau": 3,
            "multiplicateur": 40.0,
            "description": "Restaure les PV de @target.allAllies à hauteur de 40 % de leurs PV max. [00D5FF]Renvoie[-] 60 % des dégâts reçus durant 2 tour(s), puis soigne la moitié des dégâts renvoyés.\\n\\n[00D5FF]※Renvoi : renvoie une partie des dégâts reçus à l'attaquant.[-]",
            "cadre": "assets/skill-frames/ultimate-normal-3.png"
          },
          {
            "niveau": 4,
            "multiplicateur": 50.0,
            "description": "Restaure les PV de @target.allAllies à hauteur de 50 % de leurs PV max. [00D5FF]Renvoie[-] 80 % des dégâts reçus durant 2 tour(s), puis soigne la moitié des dégâts renvoyés.\\n\\n[00D5FF]※Renvoi : renvoie une partie des dégâts reçus à l'attaquant.[-]",
            "cadre": "assets/skill-frames/ultimate-normal-4.png"
          },
          {
            "niveau": 5,
            "multiplicateur": 60.0,
            "description": "Restaure les PV de @target.allAllies à hauteur de 60 % de leurs PV max. [00D5FF]Renvoie[-] 100 % des dégâts reçus durant 2 tour(s), puis soigne la moitié des dégâts renvoyés.\\n\\n[00D5FF]※Renvoi : renvoie une partie des dégâts reçus à l'attaquant.[-]",
            "cadre": "assets/skill-frames/ultimate-normal-5.png"
          },
          {
            "niveau": 6,
            "multiplicateur": 70.0,
            "description": "Restaure les PV de @target.allAllies à hauteur de 70 % de leurs PV max. [00D5FF]Renvoie[-] 120 % des dégâts reçus durant 2 tour(s), puis soigne la moitié des dégâts renvoyés.\\n\\n[00D5FF]※Renvoi : renvoie une partie des dégâts reçus à l'attaquant.[-]",
            "cadre": "assets/skill-frames/ultimate-normal-6.png"
          }
        ]
      },
      "passif": {
        "nom": "Étreinte de la Déesse",
        "image": "assets/1805001/images/icon_exclusive_skill_1805001__aafcade658f6ec07.png",
        "description": "Quand un allié meurt, il [00D5FF]ressuscite avec le même montant de PV qu'avant sa mort[-].\\n[00D5FF](Une seule fois, s'applique au début du combat. La mort par effet de renvoi empêche la résurrection et annule l'effet.)[-]",
        "niveauxUltime": [
          {
            "niveau": 1,
            "description": "Quand un allié meurt, il [00D5FF]ressuscite avec le même montant de PV qu'avant sa mort[-].\\n[00D5FF](Une seule fois, s'applique au début du combat. La mort par effet de renvoi empêche la résurrection et annule l'effet.)[-]"
  ...
  "costumes": [
    ...
    },
    {
      "id": "3355055",
      "categorie": "Skin",
      "nom": "Robe de célébration des 2,5 ans de Grand Cross",
    ...
    },
    {
      "id": "4785003",
      "categorie": "Head",
      "nom": "Couronne ailée de guerrier",
  ...
  "relique": {
    ...
    "description": "Relique sacrée de Déesse Elizabeth (arme).\\n[DC143C]Un bouclier divin qui renferme une énergie glaciale. La froideur de Svalinn peut refroidir le soleil.[-]",
    "passif": {
      "nom": "Svalinn",
      "image": "assets/commun/icon_setcostume_craft_001__d025bdbd539c2c8e.png",
      "description": "Augmente la valeur de la barrière de [00D5FF]« Bénédiction divine »[-] de [FFAE00]15 %[-]."
    },
    "bonus": [
      {
        "nom": "@stat.attack",
