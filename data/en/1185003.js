window.fichePreparee={
  "nom": "Guardian Jericho",
  "designation": "[Knight of Frost]",
  "titre": "Guardian Jericho",
  "idJeu": "1185003",
  "attribut": {
    "nom": "@attribute.1",
  ...
  "rareteParDefaut": "UR",
  "presentation": "[Knight of Frost] Guardian Jericho uses a new kind of freezing ability which inflicts damage based on remaining HP when the effect is removed.",
  "commandement": null,
  "talent": null,
  "grace": null,
  "union": null,
  "raretés": [
    {
      ...
      "competences": [
        {
          ...
          "rangs": [
            ...
            },
            {
              "rang": 2,
              "multiplicateur": 220.0,
              "description": "Inflicts damage equal to 220 % of Attack on @target.oneEnemy and [00D5FF]Freezes[-] them for 1 tour(s). Inflicts damage equal to 20 % of [00D5FF]remaining HP[-] upon removing it with a Skill, Unique, Commandment, or turns passing.\\n\\n[00D5FF]※ Freeze: Incapacitates target. Effect is removed when target is attacked.[-]",
              "idJeu": 117092,
            ...
            },
            {
              ...
              "description": "Inflicts damage equal to 360 % of Attack on @target.oneEnemy and [00D5FF]Freezes[-] them for 2 tour(s). Inflicts damage equal to 40 % of [00D5FF]remaining HP[-] upon removing it with a Skill, Unique, Commandment, or turns passing.\\n\\n[00D5FF]※ Freeze: Incapacitates target. Effect is removed when target is attacked.[-]",
              "idJeu": 117093,
          ...
          "rangs": [
            {
              ...
              "description": "Inflicts [00D5FF]Detonate[-] damage equal to 160 % of Attack on @target.oneEnemy.\\n\\n[00D5FF]※Detonate: 20 % additional damage [FFAE00]per orb[-] in the target's Ultimate Move Gauge.[-]",
              "idJeu": 117101,
              "cadre": "assets/skill-frames/rank-1.png",
              "iconeType": "assets/skill-frames/atk.png"
            },
            {
              ...
              "description": "Inflicts [00D5FF]Detonate[-] damage equal to 240 % of Attack on @target.oneEnemy.\\n\\n[00D5FF]※Detonate: 20 % additional damage [FFAE00]per orb[-] in the target's Ultimate Move Gauge.[-]",
              "idJeu": 117102,
              "cadre": "assets/skill-frames/rank-2.png",
              "iconeType": "assets/skill-frames/atk.png"
            },
            {
              ...
              "description": "Inflicts [00D5FF]Detonate[-] damage equal to 400 % of Attack on @target.oneEnemy.\\n\\n[00D5FF]※Detonate: 20 % additional damage [FFAE00]per orb[-] in the target's Ultimate Move Gauge.[-]",
              "idJeu": 117103,
              "cadre": "assets/skill-frames/rank-3.png",
              "iconeType": "assets/skill-frames/atk.png"
            }
      ...
      "ultime": {
        "nom": "\"Silent Split\"",
        "image": "assets/commun/icon_jericho_ssr_type01_special_01__bfb01e4ee6db5695.png",
        "cible": "@target.oneEnemy",
        "niveaux": [
          {
            "niveau": 1,
      ...
      "passif": {
        ...
        "description": "When an enemy takes Critical Strike damage from the hero's attack, an effect is applied on that enemy which decreases Defense-related stats by [FFAE00]40%[-] for [FFAE00]2 turns[-].",
        "niveauxUltime": [
          {
            "niveau": 1,
            "description": "When an enemy takes Critical Strike damage from the hero's attack, an effect is applied on that enemy which decreases Defense-related stats by [FFAE00]40%[-] for [FFAE00]2 turns[-]."
      ...
      "portraitVertical": "assets/commun/icon_skin_jericho_0026_l__55a22f83fac705b8.png"
    },
    {
      "id": "UR",
      "nom": "UR",
      ...
      "idForme": 301123,
      "portrait": "assets/1185003/images/icon_hero_jericho_0027_s__308e88e837209062.png",
      "portraitVertical": "assets/commun/icon_skin_jericho_0027_l__132d1f9e95493b4d.png"
    }
  ],
  "costumes": [
    {
      "id": "3301111",
      "categorie": "Skin",
      "nom": "Pink Ribbon Vest",
      "image": "assets/commun/icon_skin_jericho_0019_l__8b5c91a0d8c6fdbd.png",
      "rarete": ""
    },
    {
      "id": "3301119",
      "categorie": "Skin",
      "nom": "Warm Winter Clothes",
      "image": "assets/commun/icon_skin_jericho_0024_l__41ac07c84a97b959.png",
      "rarete": ""
    },
    {
      "id": "3301122",
      "categorie": "Skin",
      "nom": "Succession of Will",
      "image": "assets/commun/icon_skin_jericho_0026_l__55a22f83fac705b8.png",
      "rarete": ""
    },
    {
      "id": "3301116",
    ...
    },
    {
      "id": "851104",
      "categorie": "Weapon",
      "nom": "Adventuring Sword",
      "image": "assets/commun/icon_weapon_jericho_104_l__175e2c30fee95a07.png",
      "rarete": ""
    },
    {
      "id": "951103",
    ...
    },
    {
      ...
      "categorie": "Head",
      "nom": "Guardian",
      "image": "assets/commun/icon_head_jericho_0001_l__181e574b627257c1.png",
      "rarete": ""
    },
    {
      "id": "4185003",
