window.fichePreparee={
  ...
  "rareteParDefaut": "UR",
  "presentation": "[Summer Sun] Queen of Explosions Roxy's skill has an effect which disables Attack Skills of all enemies.",
  "commandement": null,
  "talent": null,
  "grace": null,
  "union": null,
  "raretés": [
    {
      ...
      "legendeImage": "disaster_roxy_0008",
      "niveau": 50,
      "statistiques": {
        "principales": [
          {
        ...
        },
        {
          ...
          "rangs": [
            ...
            },
            {
              "rang": 2,
              "multiplicateur": 120.0,
              "description": "Inflicts damage equal to 120 % of Attack on @target.allEnemies. [00D5FF]Disables Attack Skills[-] for 1 tour(s).",
              "idJeu": 180052,
              "cadre": "assets/skill-frames/rank-2.png",
            ...
            },
            {
              ...
              "description": "Inflicts damage equal to 180 % of Attack on @target.allEnemies. [00D5FF]Disables Attack Skills[-] for 2 tour(s).",
              "idJeu": 180053,
              "cadre": "assets/skill-frames/rank-3.png",
              "iconeType": "assets/skill-frames/debuff_atk_global.png"
            }
      ...
      "passif": {
        ...
        "description": "Every time the hero's Ultimate Move Gauge is completely filled, applies an effect on allies which evades an enemy's Attack or Debuff Atk Skill [FFAE00]once[-] for [FFAE00]1 turn[-].\\n[00D5FF](Excludes Death Match)[-]",
        "niveauxUltime": [
          {
            "niveau": 1,
            "description": "Every time the hero's Ultimate Move Gauge is completely filled, applies an effect on allies which evades an enemy's Attack or Debuff Atk Skill [FFAE00]once[-] for [FFAE00]1 turn[-].\\n[00D5FF](Excludes Death Match)[-]"
    ...
    },
    {
      ...
      "couleur": "#c6a5fa",
      "image": "assets/1695002/images/hero_illust_disaster_roxy_1695002__8ac5083e34a4257c.png",
      "legendeImage": "disaster_roxy_0009",
      "niveau": 60,
      "statistiques": {
        "principales": [
          {
